...
export const blockUserTemplate = (user: User, reasonKey: string) => {
    ...
    <div style="font-family:Arial,sans-serif;padding:24px;background:#f4f4f5;color:#18181b;">
      <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:16px;padding:32px;border:1px solid #e4e4e7;">
        ...
        <p style="margin:0 0 20px;font-size:15px;line-height:1.7;color:#4b5563;">
          Your account on <strong>${config.public.appName}</strong> has been temporarily restricted due to a violation of our platform rules.
        </p>

        <div style="margin:24px 0;padding:16px;border-radius:12px;background:#f9fafb;border:1px solid #e5e7eb;">
          <p style="margin:0 0 8px;font-size:13px;font-weight:600;letter-spacing:.5px;text-transform:uppercase;color:#6b7280;">
            Restriction reason
          </p>
        ...
        <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#4b5563;">
          Access to your account features will be restored automatically in 7 days.
        </p>

        <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#4b5563;">
          If you believe this restriction was applied incorrectly, please contact our support team.
        </p>
