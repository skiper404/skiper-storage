  ...
  <TabsContent value="dashboard" class="mt-6 space-y-6">
    <div class="grid gap-4 md:grid-cols-3">
      <Card class="bg-muted/30">
        <CardHeader>
          <CardTitle class="text-sm"> {{ t('features.admin.dashboard.users') }}</CardTitle>
        </CardHeader>
      ...
      <Card class="bg-muted/30">
        <CardHeader>
          <CardTitle class="text-sm"> {{ t('features.admin.dashboard.files') }}</CardTitle>
        </CardHeader>
        <CardContent class="text-3xl font-bold">
          {{ stats.totalFiles }}
        </CardContent>
      ...
      <Card class="bg-muted/30">
        <CardHeader>
          <CardTitle class="text-sm">{{ t('features.admin.dashboard.avgFilesPerUser') }}</CardTitle>
        </CardHeader>
        <CardContent class="text-3xl font-bold">
          {{ stats.filesPerUser }}
        </CardContent>
    ...
    <Card>
      <CardHeader>
        <CardTitle>{{ t('features.admin.dashboard.topUsers', { count: topUsers.length }) }}</CardTitle>
      </CardHeader>
